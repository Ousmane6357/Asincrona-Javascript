...
function cargarContenido(){
    ...
    //Funcion que cargue los elementos (imagenes etc...)
    cargarElementos();


    // funcion que cargue textos
    cargarTextos();
...
function cargarElementos(){
    document.getElementById('imgLogo').setAttribute('src', "../mongodb.webp")
    document.getElementById('titulo').textContent = "Cotizaciones Online"
    document.getElementById('imgEspera').setAttribute('src', '../loading (1).gif');
